...
import 'json_schema_dialog.dart';
            ...
            children: <Widget>[
              ...
              new SizedBox(
                ...
                child: FlatButton(
                  ...
                  onPressed: () async {
                    var listStringItems = new List<String>.from(
                        item['items'].map((data) => data["label"]).toList());
                    String returnValue = await showDialog(
                        context: context,
                        barrierDismissible: false,
                        builder: (context) => JsonSchemaDialog(
                              title: item['label'],
                  ...
                  child: Text(formGeneral['fields'][count]['value'],textAlign: TextAlign.left),
                ),
              )
